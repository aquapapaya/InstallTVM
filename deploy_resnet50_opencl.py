...
img_path = './image_classification_small/'
resulting_file_directory = 'resnet50_result'
...
def get_tvm_accuracy(graph, lib, params, ctx, img_name):
    ...
    # get raw output
    np.savetxt('output_' + img_name + '.txt', tvm_output, delimiter='\n')
